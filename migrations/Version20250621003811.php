 ...
 */
final class Version20250621003811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE pointcollecte ADD zone_id INT DEFAULT NULL, CHANGE Statut statut VARCHAR(255) DEFAULT 'actif' NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE PointCollecte DROP zone_id, CHANGE statut Statut VARCHAR(255) NOT NULL
        SQL);
    }
}
